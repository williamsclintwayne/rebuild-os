...
import { calculateProgress } from "@/modules/debt/debt.calculations"
import type { Debt } from "@/modules/debt/debt.types"
...
<template>
  <div class="mt-6 space-y-4">
    ...
    <div
      v-for="debt in store.orderedDebts"
      :key="debt.id"
    ...
    >
      ...
      <div v-else>
        <div class="flex justify-between items-center">
          <h3 class="font-semibold">{{ debt.name }}</h3>
          <div class="flex gap-2">
        ...
        <div class="mt-2 h-2 bg-gray-300 dark:bg-gray-600 rounded">
          <div
            ...
            :style="{ width: (calculateProgress(debt) * 100) + '%' }"
          ></div>
        </div>
      </div>
